...
class OAuthService {
  constructor(private client: ReturnType<typeof axios.create>) {
    // Legacy Manus-platform OAuth is unused by Kindcipe (auth is email + Apple/Google).
    // Only surface a warning if a token exchange is actually attempted without config.
  }
