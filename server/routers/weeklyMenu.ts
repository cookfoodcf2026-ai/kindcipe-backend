    ...
    .mutation(async ({ ctx, input }) => {
      ...
      await db
        ...
        .values({
          ...
          meatNameEn: input.meat?.nameEn ?? null,
          meatNameFil: input.meat?.nameFil ?? null,
          meatNameId: input.meat?.nameId ?? null,
          ...
          seafoodNameEn: input.seafood?.nameEn ?? null,
          seafoodNameFil: input.seafood?.nameFil ?? null,
          seafoodNameId: input.seafood?.nameId ?? null,
          ...
          vegNameEn: input.veg?.nameEn ?? null,
          vegNameFil: input.veg?.nameFil ?? null,
          vegNameId: input.veg?.nameId ?? null,
          vegImage: input.veg?.image ?? null,
          vegCookTime: input.veg?.cookTime ?? null,
          soupId: input.soup?.id ?? null,
          soupName: input.soup?.name ?? null,
          soupNameEn: input.soup?.nameEn ?? null,
          soupNameFil: input.soup?.nameFil ?? null,
          soupNameId: input.soup?.nameId ?? null,
