...
export const mealPlans = pgTable("meal_plans", {
  ...
  recipeNameEn: varchar("recipe_name_en", { length: 128 }),
  recipeNameFil: varchar("recipe_name_fil", { length: 128 }),
  recipeNameId: varchar("recipe_name_id", { length: 128 }),
...
export const customRecipes = pgTable("custom_recipes", {
  ...
  dishType: varchar("dish_type", { length: 32 }),
  ingredients: text("ingredients"),
  steps: text("steps"),
  stepsEn: text("steps_en"),
  stepsFil: text("steps_fil"),
  stepsId: text("steps_id"),
  tags: text("tags"),
...
// ─── KOL Creators (whitelist — partnered influencers auto-publish) ────────────
export const kolCreators = pgTable("kol_creators", {
...
export const weeklyMenu = pgTable("weekly_menu", {
  ...
  meatNameEn: varchar("meat_name_en", { length: 128 }),
  meatNameFil: varchar("meat_name_fil", { length: 128 }),
  meatNameId: varchar("meat_name_id", { length: 128 }),
  ...
  seafoodNameEn: varchar("seafood_name_en", { length: 128 }),
  seafoodNameFil: varchar("seafood_name_fil", { length: 128 }),
  seafoodNameId: varchar("seafood_name_id", { length: 128 }),
  ...
  vegNameEn: varchar("veg_name_en", { length: 128 }),
  vegNameFil: varchar("veg_name_fil", { length: 128 }),
  vegNameId: varchar("veg_name_id", { length: 128 }),
  ...
  soupNameEn: varchar("soup_name_en", { length: 128 }),
  soupNameFil: varchar("soup_name_fil", { length: 128 }),
  soupNameId: varchar("soup_name_id", { length: 128 }),
